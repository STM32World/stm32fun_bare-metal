...
extern void systick_handler(void); // Will override in systick.c
extern int main(void);             // Main function defined in main.c

extern void _estack(void); // Defined in the linker script, points to the end of the stack (initial stack pointer)
