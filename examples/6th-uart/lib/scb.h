...
struct scb {
    ...
    union {
        ...
        struct {
            ...
            volatile uint32_t RES4        : 2;  // Reserved
    ...
    union {
        volatile uint32_t reg;
        struct {
            volatile uint32_t RES1        : 9;  // Reserved
            volatile uint32_t TBLOFF      : 21; // Vector table base offset field
            volatile uint32_t RES2        : 2;  // Reserved
        } field;
    } VTOR; // 0x08
    ...
    union {
        ...
        struct {
            ...
            volatile uint32_t RES3          : 27; // Reserved
        } field;
    } SCR; // 0x10
    ...
    union {
        ...
        struct {
            ...
            volatile uint32_t RES3          : 22; // Reserved
        } field;
    } CCR; // 0x14
    ...
    union {
        ...
        struct {
            ...
            volatile uint32_t RES4           : 13; // Reserved
        } field;
    } SHCSR; // 0x24
    ...
    union {
        ...
        struct {
            ...
            volatile uint32_t RES5         : 6;  // Reserved
        } field;
    } CFSR; // 0x28
    ...
    union {
        ...
        struct {
            ...
            volatile uint32_t RES2         : 28; // Reserved
    ...
    union {
        volatile uint32_t reg;
        struct {
            volatile uint32_t RES1 : 20; // Reserved
