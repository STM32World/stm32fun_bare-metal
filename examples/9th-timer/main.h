...
// Timer Clock Logic: If PRE > 1, then Clock = APB_FREQ * 2
#define TIM_APB1_FREQ ((APB1_PRE == 1) ? (APB1_FREQUENCY) : (APB1_FREQUENCY * 2))
#define TIM_APB2_FREQ ((APB2_PRE == 1) ? (APB2_FREQUENCY) : (APB2_FREQUENCY * 2))
